...
// Module: CuFunTheory
// Imports: public import Init public import Mathlib.Analysis.Calculus.Deriv.Basic public import Mathlib.Analysis.Calculus.MeanValue public import Mathlib.MeasureTheory.Integral.IntervalIntegral.FundThmCalculus public import Mathlib.Topology.Algebra.Order.LiminfLimsup public import Mathlib.Analysis.SpecialFunctions.Log.Basic public import Mathlib.Analysis.SpecialFunctions.ExpDeriv public import Mathlib.Algebra.Order.Monoid.Basic public import Mathlib.Analysis.SpecialFunctions.Pow.Real
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Topology_Algebra_Order_LiminfLimsup(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_CuFunTheory_CuFunTheory(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Topology_Algebra_Order_LiminfLimsup(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
