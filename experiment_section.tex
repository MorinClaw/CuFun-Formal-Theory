...
MNN architecture (Theorem~\ref{thm:mnn-mono}).
...
confirmed by Theorem~\ref{thm:cdf-intensity}.
...
(Theorem~\ref{thm:mnn-mono}), letting the
...
(Theorem~\ref{thm:mnn-mono}), preventing catastrophic cancellation
